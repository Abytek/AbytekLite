/**
 * @file Data3_I32.hpp
 * @brief Defines a 3D vector with 32-bit signed integer elements
 */
#pragma once
...
{
    /**
     * @brief A 3D vector with I32 (signed int) elements
     * 
    ...
    struct TF_Data<3, 1, I32, __F_Config> : __F_Config::template TA_DefaultData<3, 1, I32, __F_Config>
    {
         ...
         * Includes SSE2 optimization when available
         */
        union
        {
            struct
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 1, I32, __F_Config>)
    {
