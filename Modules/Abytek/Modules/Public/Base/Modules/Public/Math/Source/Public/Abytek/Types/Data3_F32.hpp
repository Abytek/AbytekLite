/**
 * @file Data3_F32.hpp
 * @brief Defines a 3D vector with 32-bit floating point elements
 */
#pragma once
...
{
    /**
     * @brief A 3D vector with F32 (float) elements
     * 
     * Vector components can be accessed as X, Y, Z or as array elements.
     * SSE optimization is used when available.
     * 
     * @tparam __F_Config Configuration type for the vector
     */
    template<class __F_Config>
    struct TF_Data<3, 1, F32, __F_Config> : __F_Config::template TA_DefaultData<3, 1, F32, __F_Config>
    {
         ...
         * Includes SSE optimization when available
         */
        union
        {
            struct
...
#ifdef ABYTEK_ENABLE_SSE
        /**
         * @brief Construct from SSE vector
         * @param InXYZ_SSE SSE vector containing XYZ values
         */
        explicit ABYTEK_FORCE_INLINE TF_Data(__m128 InXYZ_SSE) noexcept :
            XYZ_SSE(InXYZ_SSE)
        {}
        
        /**
         * @brief Assignment from SSE vector
         * @param InXYZ_SSE SSE vector containing XYZ values
         * @return Reference to this vector
         */
        ABYTEK_FORCE_INLINE TF_Data& operator = (__m128 InXYZ_SSE) noexcept
        {
            XYZ_SSE = InXYZ_SSE;
            return *this;
        }
        ...
        /**
         * @brief Create a vector filled with 0.5
         * @return Vector with all components set to 0.5
         */
        ...
        /**
         * @brief Create a vector filled with 2.0
         * @return Vector with all components set to 2.0
         */
        ...
        /**
         * @brief Create a vector filled with infinity
         * @return Vector with all components set to infinity
         */
        ...
        /**
         * @brief Create a vector filled with negative infinity
         * @return Vector with all components set to negative infinity
         */
        ...
        /**
         * @brief Create a vector filled with PI
         * @return Vector with all components set to PI
         */
        ...
        /**
         * @brief Create a vector filled with PI/2
         * @return Vector with all components set to PI/2
         */
        ...
        /**
         * @brief Create a vector filled with 2*PI
         * @return Vector with all components set to 2*PI
         */
        ...
        /**
         * @brief Create a vector filled with 1/PI
         * @return Vector with all components set to 1/PI
         */
        ...
        /**
         * @brief Create a vector filled with 1/(PI/2)
         * @return Vector with all components set to 1/(PI/2)
         */
        ...
        /**
         * @brief Create a vector filled with 1/(2*PI)
         * @return Vector with all components set to 1/(2*PI)
         */
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 1, F32, __F_Config>)
    {
