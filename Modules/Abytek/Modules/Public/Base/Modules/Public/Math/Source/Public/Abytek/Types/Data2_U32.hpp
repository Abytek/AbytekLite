...
{
    /**
     * @brief Template specialization for 2D vector with unsigned integer (U32) elements
     * 
     * Implements a 2D vector with X and Y components of type U32 (32-bit unsigned integer).
    ...
    struct TF_Data<2, 1, U32, __F_Config> : __F_Config::template TA_DefaultData<2, 1, U32, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 1, U32, __F_Config>)
    {
