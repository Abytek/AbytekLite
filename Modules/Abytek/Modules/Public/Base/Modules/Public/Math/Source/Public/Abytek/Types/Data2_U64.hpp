...
{
    /**
     * @brief Template specialization for 2D vector with unsigned integer (U64) elements
     * 
     * Implements a 2D vector with X and Y components of type U64 (32-bit unsigned integer).
    ...
    struct TF_Data<2, 1, U64, __F_Config> : __F_Config::template TA_DefaultData<2, 1, U64, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 1, U64, __F_Config>)
    {
