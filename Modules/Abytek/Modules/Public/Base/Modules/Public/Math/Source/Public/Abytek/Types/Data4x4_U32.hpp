...
namespace Abytek
{
     ...
     * 
     * Specialized implementation of a 4x4 matrix using U32 (unsigned integer) elements.
     * Provides storage and operations for 4x4 matrices with unsigned integer elements.
     */
    template<class __F_Config>
    struct TF_Data<4, 4, U32, __F_Config> : __F_Config::template TA_DefaultData<4, 4, U32, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<4, 4, U32, __F_Config>)
    {
