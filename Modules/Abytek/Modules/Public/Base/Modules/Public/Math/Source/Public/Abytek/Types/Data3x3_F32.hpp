/**
 * @file Data3x3_F32.hpp
 * @brief Defines a 3x3 matrix with 32-bit floating point elements
 */
#pragma once
...
{
    /**
     * @brief A 3x3 matrix with F32 (float) elements
     * 
    ...
    struct TF_Data<3, 3, F32, __F_Config> : __F_Config::template TA_DefaultData<3, 3, F32, __F_Config>
    {
        ...
        static constexpr U32 ColumnCount = 3;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 3, F32, __F_Config>)
    {
