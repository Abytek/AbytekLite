...
{
    /**
     * @brief A 2x2 matrix with U8 (unsigned int) elements
     * 
    ...
    struct TF_Data<2, 2, U8, __F_Config> : __F_Config::template TA_DefaultData<2, 2, U8, __F_Config>
    {
        ...
        static constexpr U8 ColumnCount = 2;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 2, U8, __F_Config>)
    {
