...
{
    /**
     * @brief Template specialization for 2D vector with unsigned integer (U8) elements
     * 
     * Implements a 2D vector with X and Y components of type U8 (32-bit unsigned integer).
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 1, U8, __F_Config>)
    {
