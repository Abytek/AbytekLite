...
{
    /**
     * @brief Template specialization for 2D vector with signed integer (I32) elements
     * 
     * Implements a 2D vector with X and Y components of type I32 (32-bit signed integer).
    ...
    struct TF_Data<2, 1, I32, __F_Config> : __F_Config::template TA_DefaultData<2, 1, I32, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 1, I32, __F_Config>)
    {
