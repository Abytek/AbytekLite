...
{
    /**
     * @brief Template specialization for 2D vector with floating point (F32) elements
     * 
     * Implements a 2D vector with X and Y components of type F32 (float).
    ...
    struct TF_Data<2, 1, F32, __F_Config> : __F_Config::template TA_DefaultData<2, 1, F32, __F_Config>
    {
         ...
         * @return Vector with all elements set to infinity
         */
         ...
         * @return Vector with all elements set to negative infinity
         */
         ...
         * @return Vector with all elements set to PI
         */
         ...
         * @return Vector with all elements set to PI/2
         */
         ...
         * @return Vector with all elements set to 2*PI
         */
         ...
         * @return Vector with all elements set to 1/PI
         */
         ...
         * @return Vector with all elements set to 1/(PI/2)
         */
         ...
         * @return Vector with all elements set to 1/(2*PI)
         */
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 1, F32, __F_Config>)
    {
