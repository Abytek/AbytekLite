...
{
    /**
     * @brief A 2x2 matrix with I16 (unsigned int) elements
     * 
    ...
    struct TF_Data<2, 2, I16, __F_Config> : __F_Config::template TA_DefaultData<2, 2, I16, __F_Config>
    {
        ...
        static constexpr I16 ColumnCount = 2;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 2, I16, __F_Config>)
    {
