...
namespace Abytek
{
    ...
    struct TF_Data<4, 1, I64, __F_Config> : __F_Config::template TA_DefaultData<4, 1, I64, __F_Config>
    {
        ...
        static constexpr I64 ColumnCount = 1;
        ...
        ABYTEK_FORCE_INLINE F_Element& operator [] (I64 Idx) & noexcept
        {
        ...
        ABYTEK_FORCE_INLINE F_Element operator [] (I64 Idx) const & noexcept
        {
                        ABYTEK_BASE_MATH_ASSERT(Idx < RowCount) << "Idx out of bounds";
            return Elements[Idx];
        }
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<4, 1, I64, __F_Config>)
    {
