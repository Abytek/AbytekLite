...
{
    /**
     * @brief A 3x3 matrix with U32 (unsigned int) elements
     * 
    ...
    struct TF_Data<3, 3, U32, __F_Config> : __F_Config::template TA_DefaultData<3, 3, U32, __F_Config>
    {
         ...
         */
        ABYTEK_FORCE_INLINE F_Column& operator [] (U32 Idx) & noexcept
        {
         ...
         */
        ABYTEK_FORCE_INLINE PA_Column operator [] (U32 Idx) const & noexcept
        {
            ABYTEK_BASE_MATH_ASSERT(Idx < ColumnCount) << "Idx out of bounds";
            return Columns[Idx];
        }
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 3, U32, __F_Config>)
    {
