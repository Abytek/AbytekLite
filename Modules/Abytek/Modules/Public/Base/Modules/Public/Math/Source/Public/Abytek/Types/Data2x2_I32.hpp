/**
 * @file Data2x2_I32.hpp
 * @brief Defines a 2x2 matrix with 32-bit signed integer elements
 */
#pragma once
...
{
    /**
     * @brief A 2x2 matrix with I32 (signed int) elements
     * 
    ...
    struct TF_Data<2, 2, I32, __F_Config> : __F_Config::template TA_DefaultData<2, 2, I32, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 2, I32, __F_Config>)
    {
