/**
 * @file Data2x2_F32.hpp
 * @brief Defines a 2x2 matrix with 32-bit floating point elements
 */
#pragma once
...
{
    /**
     * @brief A 2x2 matrix with F32 (float) elements
     * 
    ...
    struct TF_Data<2, 2, F32, __F_Config> : __F_Config::template TA_DefaultData<2, 2, F32, __F_Config>
    {
        ...
        /**
         * @brief Get the top-left scalar element
        ...
        /**
         * @brief Create a matrix with a value in the top-left position
         * @param Smaller Value for top-left position
         * @return New matrix with the specified value at (0,0)
         */
        static ABYTEK_FORCE_INLINE TF_Data FromSmallerTL(PA_SmallerRectangle Smaller) noexcept
        {
            TF_Data Result;
            Result.Elements[0] = Smaller;
            return Result;
        }
        ...
        /**
         * @brief Create a matrix filled with 0.5
        ...
        /**
         * @brief Create a matrix filled with 2.0
        ...
        /**
         * @brief Create a matrix filled with infinity
        ...
        /**
         * @brief Create a matrix filled with negative infinity
        ...
        /**
         * @brief Create a matrix filled with PI
        ...
        /**
         * @brief Create a matrix filled with PI/2
        ...
        /**
         * @brief Create a matrix filled with 2*PI
        ...
        /**
         * @brief Create a matrix filled with 1/PI
        ...
        /**
         * @brief Create a matrix filled with 1/(PI/2)
         * @return Matrix with all elements set to 1/(PI/2)
         */
        ...
        /**
         * @brief Create a matrix filled with 1/(2*PI)
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 2, F32, __F_Config>)
    {
