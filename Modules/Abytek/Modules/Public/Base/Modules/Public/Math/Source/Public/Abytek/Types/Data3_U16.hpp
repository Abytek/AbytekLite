...
{
    /**
     * @brief A 3D vector with U16 (unsigned int) elements
     * 
    ...
    struct TF_Data<3, 1, U16, __F_Config> : __F_Config::template TA_DefaultData<3, 1, U16, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 1, U16, __F_Config>)
    {
