...
{
    /**
     * @brief A 3D vector with U8 (unsigned int) elements
     * 
    ...
    struct TF_Data<3, 1, U8, __F_Config> : __F_Config::template TA_DefaultData<3, 1, U8, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 1, U8, __F_Config>)
    {
