...
{
    /**
     * @brief 4x4 Matrix of 32-bit signed integer values
     * 
     * Specialized implementation of a 4x4 matrix using I32 (signed integer) elements.
     * Provides storage and operations for 4x4 matrices with integer elements.
     */
    template<class __F_Config>
    struct TF_Data<4, 4, I32, __F_Config> : __F_Config::template TA_DefaultData<4, 4, I32, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<4, 4, I32, __F_Config>)
    {
