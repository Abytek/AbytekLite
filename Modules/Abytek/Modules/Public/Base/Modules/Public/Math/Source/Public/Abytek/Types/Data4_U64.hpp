...
namespace Abytek
{
    ...
    struct TF_Data<4, 1, U64, __F_Config> : __F_Config::template TA_DefaultData<4, 1, U64, __F_Config>
    {
        using F_This = TF_Data;
        ABYTEK_BEGIN_REFLECTOR(I_Serializable)
        ABYTEK_END_REFLECTOR(F_This);
        
        static constexpr U64 RowCount = 4;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<4, 1, U64, __F_Config>)
    {
