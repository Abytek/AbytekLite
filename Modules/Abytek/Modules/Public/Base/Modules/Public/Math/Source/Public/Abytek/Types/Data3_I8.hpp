...
{
    /**
     * @brief A 3D vector with I8 (unsigned int) elements
     * 
    ...
    struct TF_Data<3, 1, I8, __F_Config> : __F_Config::template TA_DefaultData<3, 1, I8, __F_Config>
    {
        using F_This = TF_Data;
        ABYTEK_BEGIN_REFLECTOR(I_Serializable)
        ABYTEK_END_REFLECTOR(F_This);
        
        static constexpr I8 RowCount = 3;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 1, I8, __F_Config>)
    {
