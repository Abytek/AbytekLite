/**
 * @file Data3x3_I32.hpp
 * @brief Defines a 3x3 matrix with 32-bit signed integer elements
 */
#pragma once
...
{
    /**
     * @brief A 3x3 matrix with I32 (signed int) elements
     * 
    ...
    struct TF_Data<3, 3, I32, __F_Config> : __F_Config::template TA_DefaultData<3, 3, I32, __F_Config>
    {
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<3, 3, I32, __F_Config>)
    {
