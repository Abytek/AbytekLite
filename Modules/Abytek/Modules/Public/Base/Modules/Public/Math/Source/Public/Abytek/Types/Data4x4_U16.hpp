...
namespace Abytek
{
     ...
     * 
     * Specialized implementation of a 4x4 matrix using U16 (unsigned integer) elements.
     * Provides storage and operations for 4x4 matrices with unsigned integer elements.
     */
    template<class __F_Config>
    struct TF_Data<4, 4, U16, __F_Config> : __F_Config::template TA_DefaultData<4, 4, U16, __F_Config>
    {
        ...
        static constexpr U16 ColumnCount = 4;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<4, 4, U16, __F_Config>)
    {
