...
{
    /**
     * @brief Template specialization for 2D vector with unsigned integer (I64) elements
     * 
     * Implements a 2D vector with X and Y components of type I64 (32-bit unsigned integer).
    ...
    struct TF_Data<2, 1, I64, __F_Config> : __F_Config::template TA_DefaultData<2, 1, I64, __F_Config>
    {
        using F_This = TF_Data;
        ABYTEK_BEGIN_REFLECTOR(I_Serializable)
        ABYTEK_END_REFLECTOR(F_This);
        
        static constexpr I64 RowCount = 2;
    ...
    template<class __F_Config>
    ABYTEK_REFLECT(TF_Data<2, 1, I64, __F_Config>)
    {
