...
namespace Abytek
{
    ...
    namespace CanvasRendering 
    {
        ...
        struct ABYTEK_ENGINE_NFC_API F_ApplyOfflineTexturePipeline : F_GlobalRenderPipeline
        {
            ...
            static F_FeedbackStatus Build(F_Config& Config)
            {
                ...
                Config.VertexShader = ABYTEK_GLOBAL_SHADER("MainVS", "Abytek/Canvas/ApplyOffscreenTextureVS", E_RHIShaderFrequency::VERTEX);
                Config.PixelShader = ABYTEK_GLOBAL_SHADER("MainPS", "Abytek/Canvas/ApplyOffscreenTexturePS", E_RHIShaderFrequency::PIXEL);
    ...
    class ABYTEK_ENGINE_NFC_API F_CanvasComponentRenderProxy : public A_RenderableComponentProxy
    {
    public:
    ...
    private:
        ...
        TS<F_CameraComponentRenderProxy> _CameraComponentRenderProxy;
    ...
    public:
        F_CanvasComponentRenderProxy(const TW_Valid<F_CanvasComponent>& Owner);
        ~F_CanvasComponentRenderProxy() override;
