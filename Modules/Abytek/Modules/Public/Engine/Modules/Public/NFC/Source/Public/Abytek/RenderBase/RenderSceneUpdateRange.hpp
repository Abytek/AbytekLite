...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_RenderSceneUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_RenderSceneUpdateRange);
    ...
    public:
        F_RenderSceneUpdateRange();
        ~F_RenderSceneUpdateRange() override;
...
#define ABYTEK_CHECK_RENDER_SCENE_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_RenderSceneUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_RENDER_SCENE_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_RenderSceneUpdateRange::GetTaskTag())