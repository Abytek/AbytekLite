...
namespace Abytek
{
    ...
    struct ABYTEK_ENGINE_NFC_API F_RenderViewUniformDataBinding : public TF_GlobalRenderBinding<F_RenderViewUniformDataBinding>
    {
        ABYTEK_DECLARE_GLOBAL_RENDER_BINDING(F_RenderViewUniformDataBinding);
    ...
    public:
        A_RenderView(const TW_Valid<F_WorldRenderResource>& WorldRenderResource, const F_RenderViewBuildParams& BuildParams);
        ~A_RenderView() override;
    ...
    public:
        ...
        void UpdateUniformBindGroup();
        void UpdateDefaultViewportScissorConfig();
        void UpdateDepthBufferAndDSV();
    };
}
