...
namespace Abytek
{
    F_CanvasComponentRenderProxy::F_CanvasComponentRenderProxy(const TW_Valid<F_CanvasComponent>& Owner) :
        A_RenderableComponentProxy(Owner)
    {
    }
    F_CanvasComponentRenderProxy::~F_CanvasComponentRenderProxy()
    {
    }

    void F_CanvasComponentRenderProxy::OnInit_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
    }
    void F_CanvasComponentRenderProxy::OnRelease_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
    }

    void F_CanvasComponentRenderProxy::OnCreateRenderState_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
    ...
    void F_CanvasComponentRenderProxy::OnDestroyRenderState_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
    ...
    void F_CanvasComponentRenderProxy::ApplyOfflineTexture_RenderTask(
    ...
    )
    {
        ABYTEK_RHI_CAPTURE_EVENT_SCOPE(
            ...
            ABYTEK_TEXT("Abytek::F_CanvasComponentRenderProxy::ApplyOfflineTexture(Canvas = ")
                + *GetDebugName() 
                + ABYTEK_TEXT(", DstRTV = ")
                + *DstRTV->GetDebugName()
                + ABYTEK_TEXT(")")
    ...
    void F_CanvasComponentRenderProxy::CreateRHIViewport_Window_RenderTask(
        const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer,
    ...
    void F_CanvasComponentRenderProxy::ResizeRHIViewport_Window_RenderTask(
        const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer,
        const F_Vector2_U32& NewScaledClientSize
    )
    {
    ...
    void F_CanvasComponentRenderProxy::FinalizeOutput_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
        ABYTEK_RHI_CAPTURE_EVENT_SCOPE(
            SubmissionItemContainer,  
    ...
    void F_CanvasComponentRenderProxy::BeginDraw_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
#ifdef ABYTEK_DEBUG_INFO
        SubmissionItemContainer->PushAdditionalStackCaptureEventStates(
            ABYTEK_TEXT("Abytek::F_CanvasComponentRenderProxy::Draw(") + *GetDebugName() + ABYTEK_TEXT(")")
        );
#endif
        {
            ABYTEK_RHI_CAPTURE_EVENT_SCOPE(
    ...
    void F_CanvasComponentRenderProxy::EndDraw_RenderTask(const TS<A_RHISubmissionItemContainer>& SubmissionItemContainer)
    {
