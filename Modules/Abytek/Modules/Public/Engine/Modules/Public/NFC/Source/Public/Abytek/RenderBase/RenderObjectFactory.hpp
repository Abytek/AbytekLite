...
namespace Abytek
{
    ...
    public:
        virtual TS<A_RenderScene> CreateScene(const F_RenderSceneBuildParams& BuildParams) = 0;
        virtual TS<A_RenderViewFamily> CreateViewFamily(const F_RenderViewFamilyBuildParams& BuildParams) = 0;
        virtual TS<A_RenderView> CreateView(const F_RenderViewBuildParams& BuildParams) = 0;
        virtual TS<A_Renderer> CreateRenderer(const F_RendererBuildParams& BuildParams) = 0;
    };
}
