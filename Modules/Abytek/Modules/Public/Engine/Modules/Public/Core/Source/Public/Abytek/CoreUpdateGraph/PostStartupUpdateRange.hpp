...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_PostStartupUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_PostStartupUpdateRange);
    ...
    public:
        F_PostStartupUpdateRange();
        ~F_PostStartupUpdateRange() override;
...
#define ABYTEK_CHECK_POST_STARTUP_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_PostStartupUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_POST_STARTUP_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_PostStartupUpdateRange::GetTaskTag())