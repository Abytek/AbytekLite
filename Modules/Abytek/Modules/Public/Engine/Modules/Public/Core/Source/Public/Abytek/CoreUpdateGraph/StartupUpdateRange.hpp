...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_StartupUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_StartupUpdateRange);
    ...
    public:
        F_StartupUpdateRange();
        ~F_StartupUpdateRange() override;
...
#define ABYTEK_CHECK_STARTUP_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_StartupUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_STARTUP_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_StartupUpdateRange::GetTaskTag())