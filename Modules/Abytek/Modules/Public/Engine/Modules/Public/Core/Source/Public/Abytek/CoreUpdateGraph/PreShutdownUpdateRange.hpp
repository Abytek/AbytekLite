...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_PreShutdownUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_PreShutdownUpdateRange);
    ...
    public:
        F_PreShutdownUpdateRange();
        ~F_PreShutdownUpdateRange() override;
...
#define ABYTEK_CHECK_PRE_SHUTDOWN_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_PreShutdownUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_PRE_SHUTDOWN_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_PreShutdownUpdateRange::GetTaskTag())