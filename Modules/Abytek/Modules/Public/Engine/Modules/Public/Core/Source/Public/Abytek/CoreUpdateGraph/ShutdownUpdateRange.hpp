...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_ShutdownUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_ShutdownUpdateRange);
    ...
    public:
        F_ShutdownUpdateRange();
        ~F_ShutdownUpdateRange() override;
...
#define ABYTEK_CHECK_SHUTDOWN_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_ShutdownUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_SHUTDOWN_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_ShutdownUpdateRange::GetTaskTag())