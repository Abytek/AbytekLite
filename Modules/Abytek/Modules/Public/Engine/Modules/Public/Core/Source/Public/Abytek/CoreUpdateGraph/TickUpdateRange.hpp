...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_TickUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_TickUpdateRange);
...
#define ABYTEK_CHECK_TICK_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_TickUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_TICK_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_TickUpdateRange::GetTaskTag())