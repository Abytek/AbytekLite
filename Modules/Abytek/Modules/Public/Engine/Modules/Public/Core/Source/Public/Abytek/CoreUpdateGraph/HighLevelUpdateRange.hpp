...
namespace Abytek
{
    struct ABYTEK_ENGINE_CORE_API F_HighLevelUpdateRange : A_Object
    {
    public:
        ABYTEK_DECLARE_OBJECT_SINGLETON_CRT(F_HighLevelUpdateRange);
    ...
    public:
        F_HighLevelUpdateRange();
        ~F_HighLevelUpdateRange() override;
...
#define ABYTEK_CHECK_HIGH_LEVEL_UPDATE_RANGE() ABYTEK_CHECK_TASK_TAG(Abytek::F_HighLevelUpdateRange::GetTaskTag())
#define ABYTEK_CHECK_NOT_HIGH_LEVEL_UPDATE_RANGE() ABYTEK_CHECK_NOT_TASK_TAG(Abytek::F_HighLevelUpdateRange::GetTaskTag())