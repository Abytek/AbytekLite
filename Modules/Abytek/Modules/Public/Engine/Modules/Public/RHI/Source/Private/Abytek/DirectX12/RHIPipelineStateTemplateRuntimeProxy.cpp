...
namespace Abytek
{
    void F_DirectX12RHIPipelineStateTemplateRuntimeProxy::LateBuildPipelineStateTemplateRuntime_DirectX12()
    {
        auto CastedPipelineStateTemplateRuntime = GetPipelineStateTemplateRuntime().FastCast<F_DirectX12RHIPipelineStateTemplateRuntime>();
        _RootSignatureTemplateRuntimeProxy = CastedPipelineStateTemplateRuntime->GetRootSignatureTemplateRuntime()->GetProxy().FastCast<
            F_DirectX12RHIRootSignatureTemplateRuntimeProxy    
        >();
    }
    void F_DirectX12RHIPipelineStateTemplateRuntimeProxy::Release()
    {
        _RootSignatureTemplateRuntimeProxy = {};
        A_RHIPipelineStateTemplateRuntimeProxy::Release();
    }
    
    void F_DirectX12RHIPipelineStateTemplateRuntimeProxy::InitD3D12PipelineState()
    {
        switch (
            GetTemplate()
    ...
    void F_DirectX12RHIPipelineStateTemplateRuntimeProxy::_InitGraphics()
    {
        auto D3D12Device = GetContextProxy()->GetDevice().FastCast<F_DirectX12RHIDevice>()->GetD3D12Device();
        
        auto CastedTemplate = GetTemplate().FastCast<F_DirectX12SharedRHIPipelineStateTemplate>();
        ...
        if (CompiledData.MeshShader || CompiledData.AmplificationShader)
        {
            ...
            D3D12XPipelineStateDesc.pRootSignature = _RootSignatureTemplateRuntimeProxy->GetD3D12RootSignature().Get();
        ...
        else
        {
            ...
            D3D12PipelineStateDesc.pRootSignature = _RootSignatureTemplateRuntimeProxy->GetD3D12RootSignature().Get();
    ...
    void F_DirectX12RHIPipelineStateTemplateRuntimeProxy::_InitCompute()
    {
        auto D3D12Device = GetContextProxy()->GetDevice().FastCast<F_DirectX12RHIDevice>()->GetD3D12Device();
        ...
        D3D12ComputePipelineStateDesc.pRootSignature = _RootSignatureTemplateRuntimeProxy->GetD3D12RootSignature().Get();
    ...
    void F_DirectX12RHIPipelineStateTemplateRuntimeProxy::_InitWorkGraph()
    {
