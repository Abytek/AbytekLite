...
function(Abytek_GitHelper_Clone)

    cmake_parse_arguments(
            PARGS                                                                                                         # prefix of output variables
            "QUIET;UPDATE_SUBMODULES"                                                                                                       # list of names of the boolean arguments (only defined ones will be true)
    ...
    if(PARGS_GIT_BRANCH)
        if(PARGS_UPDATE_SUBMODULES)
            execute_process(
                COMMAND             ${GIT_EXECUTABLE} clone --recurse-submodules -b ${PARGS_GIT_BRANCH} ${PARGS_GIT_URL}
        ...
        if(PARGS_UPDATE_SUBMODULES)
            execute_process(
                COMMAND             ${GIT_EXECUTABLE} clone --recurse-submodules ${PARGS_GIT_URL}
                WORKING_DIRECTORY   ${PARGS_DIRECTORY}
                RESULT_VARIABLE     git_result
                OUTPUT_VARIABLE     git_output
            )
