...
function(Abytek_DocsHelper_CreateTarget)
    ...
    if(DOXYGEN_FOUND)
        ...
        FILE(RELATIVE_PATH CWD_DIR_TO_DOXYGEN_THEME_DIR ${PARGS_CWD} ${doxygen_awesome_css_SOURCE_DIR})
        ...
        doxygen_add_docs(${PARGS_TARGET_NAME}
            ...
            COMMENT "Generate Abytek documentation"
        )
        ...
        message(SEND_ERROR "<Abytek::Documentation> Not found doxygen")
    endif()
endfunction()
